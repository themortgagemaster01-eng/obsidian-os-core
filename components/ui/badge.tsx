...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium transition-colors duration-200 ease-in-out",
  {
    variants: {
      variant: {
        default: "border-transparent bg-white/10 text-foreground",
        outline: "border-border text-foreground",
        navy: "border-transparent bg-navy-accent/60 text-foreground",
