...
**Approval Queue UI** — the screen that finally gives `decision-service.ts::logDecision()` a real caller, and the point at which the Decision Intelligence layer starts accumulating genuine training data instead of sitting unused.
