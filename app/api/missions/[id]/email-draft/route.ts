...
export async function POST(_request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    console.error(`[POST /api/missions/${params.id}/email-draft] supabase.auth.getUser() threw:`, err);
  ...
  try {
    ...
    // eslint-disable-next-line no-console
    console.error(`[POST /api/missions/${params.id}/email-draft] mission lookup failed:`, err);
