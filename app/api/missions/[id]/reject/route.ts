...
export async function POST(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    console.error(`[POST /api/missions/${params.id}/reject] supabase.auth.getUser() threw:`, err);
  ...
  try {
    ...
    // eslint-disable-next-line no-console
    console.error(`[POST /api/missions/${params.id}/reject] mission lookup failed:`, err);
