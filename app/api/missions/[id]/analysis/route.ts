...
export async function GET(_request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    console.error(`[GET /api/missions/${params.id}/analysis] supabase.auth.getUser() threw:`, err);
  ...
  try {
    ...
    // eslint-disable-next-line no-console
    console.error(`[GET /api/missions/${params.id}/analysis] mission lookup failed:`, err);
