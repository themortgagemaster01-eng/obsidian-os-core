...
/**
 * The Ledger's one deliberate serif signature — reserved for business names
 * only (see components/mission-control/mission-list.tsx). Everything else in
 * the product stays on the Inter grotesk system above.
 */
